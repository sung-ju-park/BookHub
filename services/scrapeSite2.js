...
export async function scrapeSite2(browser, book_name) {
    ...
    if (!isResultsExist) {
        console.log('site 2 : 검색 결과가 없습니다.');
        await page.close();
        return [];
    }
    ...
    const results = await page.evaluate(() => {
        ...
        lis.forEach(li => {
          ...
          if (!titleElement) {
            console.log('Site 2: 제목이 없는 자료가 있습니다.');
            return;
          }
    ...
    console.log('site 2 :', firstThreeResults);
